...
class FavoriteScreen extends StatefulWidget {
  final List<String> favoritePhoto;
  FavoriteScreen({required this.favoritePhoto, super.key});
...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  void initState() {
    super.initState();
    favoriteItems = widget.favoritePhoto;
  }
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                  itemCount: widget.favoritePhoto.length,
                      ...
                      child: Container(
                        ...
                        child: GestureDetector(
                            onTap: () {
                              ...
                              saveFavorites();
                            }, //Text('Webtoon ${index + 1}')
                            child: Column(
                              children: [
                                Image.asset(
                                  widget.favoritePhoto[index],
                                  fit: BoxFit.fill,
                                  height: 150,
                                ),
                                TextButton(
                                      ...
                                      Navigator.pushReplacement(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) => DetailScreen(
                                              webimage: favoriteItems[index],
                                              description: webDesc[index],
                                            ),
                                          ));
                                    },
                                    child: const Text(
                                      "Go to Details of the Item.",
                                      style: TextStyle(
                                          color: Colors.white,
